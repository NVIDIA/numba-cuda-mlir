...
constexpr const char* ERROR_CODE_GLOBAL_NAME = "__cusimt_error_code";
...
Result<CudaLibrary> load_cuda_library(const void* cubin) {
    ...
    if (res != CUDA_SUCCESS || ctx == nullptr) {
        return raise(PyExc_RuntimeError,
            ...
            "This typically happens automatically when using cuda.simt operations.");
    }
...
PyTypeObject KernelDispatcher_type = {
    .tp_name = "cusimt._cext.KernelDispatcher",
...
PyTypeObject LaunchConfiguration_type = {
    .tp_name = "cusimt._cext.LaunchConfiguration",
...
void try_get_numba_globals() {
    PyPtr numba_cuda = try_import("cusimt.numba_cuda");
