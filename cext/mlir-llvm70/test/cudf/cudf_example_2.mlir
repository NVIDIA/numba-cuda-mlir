...
module {
  gpu.module @cusimt_gpu_module [#nvvm_llvm70.target<O = 3, chip = "sm_75">] attributes {cusimt.link_target} {
    llvm.func @_Z7_kernel5TupleI5ArrayIiLi1E1C7mutable7alignedE5ArrayIbLi1E1C7mutable7alignedEEx14string_view_2ax(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64, %arg11: !llvm.ptr, %arg12: i64) attributes {cusimt.arg_attrs = [{}, {}, {}, {}, {}], cusimt.orig_arg_types = [memref<?xi32, strided<[?], offset: ?>>, memref<?xi1, strided<[?], offset: ?>>, i64, !llvm.ptr, i64], gpu.kernel, llvm.emit_c_interface, nvvm.kernel} {
