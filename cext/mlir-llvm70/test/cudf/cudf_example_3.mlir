...
module {
  gpu.module @numba_cuda_mlir_gpu_module [#nvvm_llvm70.target<O = 3, chip = "sm_75">] attributes {numba_cuda_mlir.link_target} {
    llvm.mlir.global internal constant @__numba_cuda_mlir_str_1("h\00") {addr_space = 0 : i32} : !llvm.array<2 x i8>
    llvm.func @_Z12_3clambda_3e3RowILi831EE(%arg0: !llvm.ptr) -> !llvm.struct<"Masked(bool)", (i1, i1)> attributes {numba_cuda_mlir.arg_attrs = [{}], numba_cuda_mlir.orig_arg_types = [!llvm.ptr]} {
      %0 = llvm.mlir.undef : !llvm.struct<"Masked(bool)", (i1, i1)>
      %1 = llvm.mlir.undef : !llvm.struct<"string_view", (ptr, i32, i32)>
      %2 = llvm.mlir.constant(1 : i32) : i32
      %3 = llvm.mlir.constant(1 : i64) : i64
      %4 = llvm.mlir.addressof @__numba_cuda_mlir_str_1 : !llvm.ptr
...
// CHECK: @__numba_cuda_mlir_str_1 = internal global [2 x i8] c"h\00"
