...
To use something in a cuSIMT kernel, we need to tell the type system how to type
...
```python
# Type math.ceil in cusimt/typing/math.py
...
# Lower math.ceil in cusimt/lowering/math.py
