...
import sys
import inspect
import cusimt.runtime as rt
from cusimt.compiler import declare_mlir_library
from cusimt.errors import (
...
from cusimt._mlir.ir import UnitAttr
...
def _intrinsic_from_func(func):
    from cusimt.mlir.context import mlir_mod_ctx
    from cusimt.mlir.dialect_exts.func import func as mlir_func
...
def define(func_or_source):
    ...
    - cusimt types: `types.int32`, `types.float32`, etc. (recommended)
