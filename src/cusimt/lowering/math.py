...
@lower(cusimt.types.ptr, types.Array)
...
@lower(operator.sub, cusimt.types.ptr, types.Integer)
@lower(operator.sub, types.Integer, cusimt.types.ptr)
...
@lower(operator.add, cusimt.types.ptr, types.Integer)
@lower(operator.add, types.Integer, cusimt.types.ptr)
