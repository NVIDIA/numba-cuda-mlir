...
from cusimt.numba_cuda.core.imputils import Registry as TargetRegistry
from cusimt.numba_cuda.core.imputils import lower_cast
from cusimt.numba_cuda.typing import signature
from cusimt.numba_cuda.typing.builtins import (
    BinOp,
    BinOpTrueDiv,
    UnaryNegate,
    UnaryPositive,
...
from cusimt.numba_cuda.typing.templates import AttributeTemplate, ConcreteTemplate
from cusimt.numba_cuda.typing.templates import Registry as TypingRegistry
from cusimt.numba_cuda import CUSource, declare_device
from cusimt.numba_cuda.vector_types import vector_types
from cusimt.numba_cuda.extending import as_numba_type
...
class _ctor_template___nv_bfloat162(ConcreteTemplate):
    ...
    cases = [
        ...
        signature(_type___nv_bfloat162, _type___nv_bfloat16, _type___nv_bfloat16),
        signature(_type___nv_bfloat162, _type___nv_bfloat162),
...
def _lower__ZL19__float2bfloat16_rnf_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__float2bfloat16_rnf_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__float2bfloat16_rzf_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__float2bfloat16_rzf_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__float2bfloat16_rdf_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__float2bfloat16_rdf_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__float2bfloat16_ruf_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__float2bfloat16_ruf_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__float2bfloat162_rnf_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__float2bfloat162_rnf_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL21__floats2bfloat162_rnff_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL21__floats2bfloat162_rnff_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
        ...
        return context.compile_internal(
            ...
            signature(_type___nv_bfloat162, CPointer(float32), CPointer(float32)),
            ptrs,
        )
...
def _lower__ZL19__short2bfloat16_rns_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__short2bfloat16_rns_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__short2bfloat16_rzs_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__short2bfloat16_rzs_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__short2bfloat16_rds_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__short2bfloat16_rds_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__short2bfloat16_rus_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__short2bfloat16_rus_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL18__uint2bfloat16_rnj_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL18__uint2bfloat16_rnj_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL18__uint2bfloat16_rzj_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL18__uint2bfloat16_rzj_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL18__uint2bfloat16_rdj_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL18__uint2bfloat16_rdj_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL18__uint2bfloat16_ruj_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL18__uint2bfloat16_ruj_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__ushort2bfloat16_rnt_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__ushort2bfloat16_rnt_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__ushort2bfloat16_rzt_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__ushort2bfloat16_rzt_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__ushort2bfloat16_rdt_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__ushort2bfloat16_rdt_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__ushort2bfloat16_rut_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__ushort2bfloat16_rut_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6htrunc13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6htrunc13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL5hceil13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL5hceil13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6hfloor13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6hfloor13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL5hrint13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL5hrint13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7h2trunc14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7h2trunc14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6h2ceil14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6h2ceil14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7h2floor14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7h2floor14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6h2rint14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6h2rint14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL8__hisinf13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL8__hisinf13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL19__short_as_bfloat16s_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL19__short_as_bfloat16s_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL20__ushort_as_bfloat16t_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL20__ushort_as_bfloat16t_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL11__shfl_syncj14__nv_bfloat162ii_nbst(shim_stream, shim_obj):
    ...
    def _ZL11__shfl_syncj14__nv_bfloat162ii_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL11__shfl_syncj14__nv_bfloat162ii_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL14__shfl_up_syncj14__nv_bfloat162ji_nbst(shim_stream, shim_obj):
    ...
    def _ZL14__shfl_up_syncj14__nv_bfloat162ji_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL14__shfl_up_syncj14__nv_bfloat162ji_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL15__shfl_xor_syncj14__nv_bfloat162ii_nbst(shim_stream, shim_obj):
    ...
    def _ZL15__shfl_xor_syncj14__nv_bfloat162ii_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL15__shfl_xor_syncj14__nv_bfloat162ii_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL11__shfl_syncj13__nv_bfloat16ii_nbst(shim_stream, shim_obj):
    ...
    def _ZL11__shfl_syncj13__nv_bfloat16ii_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL11__shfl_syncj13__nv_bfloat16ii_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL14__shfl_up_syncj13__nv_bfloat16ji_nbst(shim_stream, shim_obj):
    ...
    def _ZL14__shfl_up_syncj13__nv_bfloat16ji_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL14__shfl_up_syncj13__nv_bfloat16ji_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL16__shfl_down_syncj13__nv_bfloat16ji_nbst(shim_stream, shim_obj):
    ...
    def _ZL16__shfl_down_syncj13__nv_bfloat16ji_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL16__shfl_down_syncj13__nv_bfloat16ji_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL15__shfl_xor_syncj13__nv_bfloat16ii_nbst(shim_stream, shim_obj):
    ...
    def _ZL15__shfl_xor_syncj13__nv_bfloat16ii_nbst_caller(arg_0, arg_1, arg_2, arg_3):
        return _ZL15__shfl_xor_syncj13__nv_bfloat16ii_nbst(arg_0, arg_1, arg_2, arg_3)
...
def _lower__ZL5__ldgPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL5__ldgPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
        ...
        return context.compile_internal(
            ...
            signature(_type___nv_bfloat162, CPointer(CPointer(_type___nv_bfloat162))),
            ptrs,
        )
...
def _lower__ZL5__ldgPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL5__ldgPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
        ...
        return context.compile_internal(
            ...
            signature(_type___nv_bfloat16, CPointer(CPointer(_type___nv_bfloat16))),
            ptrs,
        )
...
def _lower__ZL6__ldcgPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcgPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcgPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcgPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcaPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcaPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcaPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcaPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcsPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcsPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcsPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcsPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldluPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldluPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldluPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldluPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcvPK14__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcvPK14__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__ldcvPK13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__ldcvPK13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stwbP14__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stwbP14__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stwbP13__nv_bfloat16S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stwbP13__nv_bfloat16S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stcgP14__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stcgP14__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stcgP13__nv_bfloat16S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stcgP13__nv_bfloat16S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stcsP14__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stcsP14__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stcsP13__nv_bfloat16S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stcsP13__nv_bfloat16S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stwtP14__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stwtP14__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stwtP13__nv_bfloat16S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__stwtP13__nv_bfloat16S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__heq214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__heq214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hne214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__hne214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hle214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__hle214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hge214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__hge214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hlt214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__hlt214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hgt214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL6__hgt214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hequ214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hequ214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hneu214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hneu214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hleu214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hleu214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hgeu214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hgeu214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hltu214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hltu214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hgtu214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hgtu214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL9__hisnan214__nv_bfloat162_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL9__hisnan214__nv_bfloat162_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hadd214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hadd214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hsub214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hsub214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7__hmul214__nv_bfloat162S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL7__hmul214__nv_bfloat162S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL7
nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZN6__halfC1E13__nv_bfloat16_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZN6__halfC1E13__nv_bfloat16_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
register_global(__float2bfloat16_rn, types.Function(_typing___float2bfloat16_rn))
...
register_global(__float2bfloat16_rz, types.Function(_typing___float2bfloat16_rz))
...
register_global(__float2bfloat16_rd, types.Function(_typing___float2bfloat16_rd))
...
register_global(__float2bfloat16_ru, types.Function(_typing___float2bfloat16_ru))
...
register_global(__float2bfloat162_rn, types.Function(_typing___float2bfloat162_rn))
...
register_global(__floats2bfloat162_rn, types.Function(_typing___floats2bfloat162_rn))
...
register_global(__float22bfloat162_rn, types.Function(_typing___float22bfloat162_rn))
...
register_global(__bfloat162uchar_rz, types.Function(_typing___bfloat162uchar_rz))
...
register_global(__bfloat162short_rn, types.Function(_typing___bfloat162short_rn))
...
register_global(__bfloat162short_rz, types.Function(_typing___bfloat162short_rz))
...
register_global(__bfloat162short_rd, types.Function(_typing___bfloat162short_rd))
...
register_global(__bfloat162short_ru, types.Function(_typing___bfloat162short_ru))
...
register_global(__short2bfloat16_rn, types.Function(_typing___short2bfloat16_rn))
...
register_global(__short2bfloat16_rz, types.Function(_typing___short2bfloat16_rz))
...
register_global(__short2bfloat16_rd, types.Function(_typing___short2bfloat16_rd))
...
register_global(__short2bfloat16_ru, types.Function(_typing___short2bfloat16_ru))
...
register_global(__bfloat162ushort_rn, types.Function(_typing___bfloat162ushort_rn))
...
register_global(__bfloat162ushort_rz, types.Function(_typing___bfloat162ushort_rz))
...
register_global(__bfloat162ushort_rd, types.Function(_typing___bfloat162ushort_rd))
...
register_global(__bfloat162ushort_ru, types.Function(_typing___bfloat162ushort_ru))
...
register_global(__ushort2bfloat16_rn, types.Function(_typing___ushort2bfloat16_rn))
...
register_global(__ushort2bfloat16_rz, types.Function(_typing___ushort2bfloat16_rz))
...
register_global(__ushort2bfloat16_rd, types.Function(_typing___ushort2bfloat16_rd))
...
register_global(__ushort2bfloat16_ru, types.Function(_typing___ushort2bfloat16_ru))
...
register_global(__bfloat162bfloat162, types.Function(_typing___bfloat162bfloat162))
...
register_global(__bfloat16_as_short, types.Function(_typing___bfloat16_as_short))
...
register_global(__bfloat16_as_ushort, types.Function(_typing___bfloat16_as_ushort))
...
register_global(__short_as_bfloat16, types.Function(_typing___short_as_bfloat16))
...
register_global(__ushort_as_bfloat16, types.Function(_typing___ushort_as_bfloat16))
...
class _typing___shfl_sync(ConcreteTemplate):
    ...
    cases = [
        signature(_type___nv_bfloat162, uint32, _type___nv_bfloat162, int32, int32),
        signature(_type___nv_bfloat16, uint32, _type___nv_bfloat16, int32, int32),
    ]
...
class _typing___shfl_up_sync(ConcreteTemplate):
    ...
    cases = [
        signature(_type___nv_bfloat162, uint32, _type___nv_bfloat162, uint32, int32),
        signature(_type___nv_bfloat16, uint32, _type___nv_bfloat16, uint32, int32),
    ]
...
class _typing___hadd(ConcreteTemplate):
    key = globals()["__hadd"]
    cases = [signature(_type___nv_bfloat16, _type___nv_bfloat16, _type___nv_bfloat16)]
