...
from cusimt.numba_cuda._internal.cuda_bf16 import _type___nv_bfloat16
...
__half = _type___half = types.float16
...
def _lower__ZN6__halfC1Ev(shim_stream, shim_obj):
    ...
    def ctor_impl(context, builder, sig, args):
        ...
        selfptr = builder.alloca(context.get_value_type(_type___half), name="selfptr")
        ...
        return builder.load(selfptr, align=getattr(_type___half, "alignof_", None))
...
def _lower__ZN6__halfC1ERK10__half_raw(shim_stream, shim_obj):
    ...
    def ctor_impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZN6__halfC1ERK10__half_raw_nbst", shim_raw_str)
        selfptr = builder.alloca(context.get_value_type(_type___half), name="selfptr")
        argptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(argptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
        ...
        context.compile_internal(
            builder,
            __half_device_caller,
            signature(int32, CPointer(_type___half), CPointer(_type_unnamed1362071)),
            (selfptr, *argptrs),
        )
        return builder.load(selfptr, align=getattr(_type___half, "alignof_", None))
...
def _lower__ZN6__halfC1E13__nv_bfloat16(shim_stream, shim_obj):
    ...
    def ctor_impl(context, builder, sig, args):
        ...
        context.compile_internal(
            builder,
            __half_device_caller,
            signature(int32, CPointer(_type___half), CPointer(_type___nv_bfloat16)),
            (selfptr, *argptrs),
        )
        return builder.load(selfptr, align=getattr(_type___half, "alignof_", None))
...
def _lower__ZL12__half2float6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12__half2float6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__half2char_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__half2char_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half2uchar_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half2uchar_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half2short_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half2short_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__half2ushort_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__half2ushort_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2int_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2int_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__half2uint_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__half2uint_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL12__half2ll_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12__half2ll_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2ull_rz6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2ull_rz6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2int_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2int_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2int_rd6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2int_rd6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2int_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2int_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half2short_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half2short_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half2short_rd6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half2short_rd6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half2short_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half2short_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__half2uint_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__half2uint_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__half2uint_rd6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__half2uint_rd6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__half2uint_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__half2uint_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__half2ushort_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__half2ushort_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__half2ushort_rd6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__half2ushort_rd6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__half2ushort_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__half2ushort_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2ull_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2ull_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL13__half2ull_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL13__half2ull_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL12__half2ll_rn6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12__half2ll_rn6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL12__half2ll_rd6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12__half2ll_rd6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL12__half2ll_ru6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12__half2ll_ru6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__half_as_short6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__half_as_short6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__half_as_ushort6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__half_as_ushort6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__hmax6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        ...
        return context.compile_internal(
            ...
            signature(_type___half, CPointer(_type___half), CPointer(_type___half)),
            ptrs,
        )
...
def _lower__ZL11__shfl_syncj6__halfii_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL11__shfl_syncj6__halfii_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL14__shfl_up_syncj6__halfji_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL14__shfl_up_syncj6__halfji_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL16__shfl_down_syncj6__halfji_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL16__shfl_down_syncj6__halfji_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL15__shfl_xor_syncj6__halfii_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL15__shfl_xor_syncj6__halfii_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL6__stwbP6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        ...
        return context.compile_internal(
            ...
            signature(void, CPointer(CPointer(_type___half)), CPointer(_type___half)),
            ptrs,
        )
...
def _lower__ZL10__hadd_sat6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hadd_sat6__halfS__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL10__hsub_sat6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hsub_sat6__halfS__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL10__hmul_sat6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hmul_sat6__halfS__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL10__hfma_sat6__halfS_S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hfma_sat6__halfS_S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL10__hmax_nan6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hmax_nan6__halfS__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL10__hmin_nan6__halfS__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL10__hmin_nan6__halfS__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL11__hfma_relu6__halfS_S__nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL11__hfma_relu6__halfS_S__nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
...
def _lower__ZL12htanh_approx6__half_nbst(shim_stream, shim_obj):
    ...
    def impl(context, builder, sig, args):
        context.active_code_library.add_linking_file(shim_obj)
        shim_stream.write_with_key("_ZL12htanh_approx6__half_nbst", shim_raw_str)
        ptrs = [builder.alloca(context.get_value_type(arg)) for arg in sig.args]
        for ptr, ty, arg in zip(ptrs, sig.args, args):
            builder.store(arg, ptr, align=getattr(ty, "alignof_", None))
