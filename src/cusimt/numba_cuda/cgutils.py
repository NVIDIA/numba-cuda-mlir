...
from cusimt.numba_cuda import config, utils, debuginfo
import cusimt.numba_cuda.datamodel
...
class _StructProxy:
    ...
    def __init__(self, context, builder, value=None, ref=None):
        ...
        if not isinstance(self._datamodel, cusimt.numba_cuda.datamodel.StructModel):
