...
from cusimt.numba_cuda.core.codegen import Codegen, CodeLibrary
from cusimt.numba_cuda.cudadrv.libs import get_cudalib
from cusimt.numba_cuda.cudadrv.linkable_code import LinkableCode
from cusimt.numba_cuda.memory_management.nrt import NRT_LIBRARY
...
class CUDACodeLibrary(serialize.ReduceMixin, CodeLibrary):
    ...
    def get_cubin(self, cc=None):
        ...
        linker = driver._Linker(max_registers=self._max_registers, cc=cc, lto=self._lto)
