...
from cusimt.numba_cuda.core import imputils, targetconfig, funcdesc
from cusimt.numba_cuda import cgutils, debuginfo, types, utils, datamodel, config
from cusimt.numba_cuda.core import errors
from cusimt.numba_cuda.core.compiler_lock import global_compiler_lock
from cusimt.numba_cuda.core.pythonapi import PythonAPI
...
class BaseContext:
    ...
    @cached_property
    def nrt(self):
        from cusimt.numba_cuda.memory_management.nrt_context import NRTContext
