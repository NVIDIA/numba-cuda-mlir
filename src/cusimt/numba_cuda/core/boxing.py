...
from cusimt.numba_cuda import types, cgutils
from cusimt.numba_cuda.core.pythonapi import box, unbox, reflect, NativeValue
from cusimt.numba_cuda.core.errors import NumbaNotImplementedError, TypingError
from cusimt.numba_cuda.typing.typeof import typeof, Purpose

from cusimt.numba_cuda.cpython import setobj, listobj
...
def unbox_numpy_random_bitgenerator(typ, obj, c):
    ...
    * bit_generator (ctypes.c_void_p)
    ...
    with ExitStack() as stack:
        ...
        struct_ptr.state_address = c.unbox(types.uintp, interface_state_address).value
