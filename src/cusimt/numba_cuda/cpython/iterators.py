...
@lower("getiter", types.IteratorType)
...
@lower(enumerate, types.IterableType, types.Integer)
...
@lower("iternext", types.EnumerateType)
...
@lower(zip, types.VarArg(types.Any))
...
@lower("iternext", types.Generator)
@iternext_impl(RefType.BORROWED)
def iternext_zip(context, builder, sig, args, result):  # noqa: F811
    (genty,) = sig.args
    (gen,) = args
