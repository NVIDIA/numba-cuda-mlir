...
from cusimt.numba_cuda.core.imputils import impl_ret_untracked, Registry
from cusimt.numba_cuda import types
from cusimt.numba_cuda.core import errors
from cusimt.numba_cuda.extending import overload_method
from cusimt.numba_cuda.cpython.unsafe.numbers import viewer
from cusimt.numba_cuda import cgutils, typing
...
def real_divmod(context, builder, x, y):
    ...
    call_conv = context.fndesc.call_conv
    fname = call_conv.mangler(".numba.python.rem", [x.type])
...
def real_negate_impl(context, builder, sig, args):
    from cusimt.numba_cuda.cpython import mathimpl
