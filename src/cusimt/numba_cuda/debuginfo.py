...
from cusimt.numba_cuda.datamodel.models import ComplexModel, UnionModel, UniTupleModel
from cusimt.numba_cuda.types.ext_types import GridGroup
    ...
    def _var_type(self, lltype, size, datamodel=None):
        ...
        if isinstance(datamodel, UnionModel):
            ...
            if config.CUDA_DEBUG_POLY:
                ...
                elements_metadata = m.add_metadata([discriminator, variant_part_type])
