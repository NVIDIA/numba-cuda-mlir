...
from cusimt.numba_cuda.np.ufunc.ufuncbuilder import _BaseUFuncBuilder, parse_identity
...
class GUFuncEngine:
    ...
    def schedule(self, ishapes):
        ...
        # solve output shape
        oshapes = [tuple(map(symbolmap.__getitem__, outsig)) for outsig in self.sout]
