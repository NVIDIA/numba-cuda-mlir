...
from cusimt.numba_cuda import types, utils, config

# # Exported symbols
from cusimt.numba_cuda.typing.typeof import typeof_impl  # noqa: F401
from cusimt.numba_cuda.typing.asnumbatype import as_numba_type  # noqa: F401
from cusimt.numba_cuda.typing.templates import infer, infer_getattr  # noqa: F401

from cusimt.numba_cuda.core.imputils import (  # noqa: F401
    lower_builtin,
    lower_getattr,
...
from cusimt.numba_cuda.core.pythonapi import (
    box,
    unbox,
    reflect,
    NativeValue,
)  # noqa: F401
from cusimt.numba_cuda.serialize import ReduceMixin
from cusimt.numba_cuda.datamodel import models as core_models  # noqa: F401


from cusimt.numba_cuda.models import register_model  # noqa: F401
from cusimt.numba_cuda import models  # noqa: F401
...
def make_attribute_wrapper(typeclass, struct_attr, python_attr):
    ...
    Vendored from cusimt.numba_cuda.extending with a change to consider the CUDA data
    model manager.
    """
    from cusimt.numba_cuda.typing.templates import AttributeTemplate
    from cusimt.numba_cuda.datamodel import default_manager
    from cusimt.numba_cuda.datamodel.models import StructModel
    from cusimt.numba_cuda.core.imputils import impl_ret_borrowed
    from cusimt.numba_cuda import cgutils

    from cusimt.numba_cuda.models import cuda_data_manager
    from cusimt.numba_cuda.cudadecl import registry as cuda_registry
    from cusimt.numba_cuda.cudaimpl import registry as cuda_impl_registry
...
def overload(
    ...
    **kwargs prescribes additional arguments passed through to the overload
    ...
    """
    from cusimt.numba_cuda.typing.templates import make_overload_template, infer_global
...
def overload_attribute(typ, attr, target="cuda", **kwargs):
    ...
    *kwargs* are passed to the underlying `@overload` call.
    ...
    from cusimt.numba_cuda.typing.templates import make_overload_attribute_template
...
def _overload_method_common(typ, attr, **kwargs):
    ...
    from cusimt.numba_cuda.typing.templates import make_overload_method_template
