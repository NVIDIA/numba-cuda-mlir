...
from cusimt.numba_cuda.core.targetconfig import TargetConfig, Option

from cusimt.numba_cuda.core.options import (
    ParallelOptions,
    FastMathOptions,
    InlineOptions,
)

from cusimt.numba_cuda.core.callconv import BaseCallConv
...
class CUDAFlags(Flags):
    ...
    max_registers = Option(type=_optional_int_type, default=None, doc="Max registers")
