...
from cusimt.numba_cuda import debuginfo, cgutils, utils, typing, types
...
from cusimt.numba_cuda.core.funcdesc import default_mangler
from cusimt.numba_cuda.core.environment import Environment
from cusimt.numba_cuda.core.analysis import compute_use_defs, must_use_alloca
from cusimt.numba_cuda.misc.firstlinefinder import get_func_def_lineno
from cusimt.numba_cuda.misc.coverage_support import get_registered_loc_notify
...
class Lower(BaseLower):
    ...
    def pre_block(self, block):
        from cusimt.numba_cuda.core.unsafe import eh
    ...
    def _lower_call_ObjModeDispatcher(self, fnty, expr, signature):
        from cusimt.numba_cuda.core.pythonapi import ObjModeUtils
