...
from cusimt.numba_cuda import config, types
...
from cusimt.numba_cuda.utils import _readenv, cached_file_read
from cusimt.numba_cuda.cudadrv.linkable_code import CUSource
from cusimt.numba_cuda.typing.templates import signature

from cusimt.numba_cuda.extending import intrinsic, overload_classmethod
...
class _Runtime:
    ...
    def allocate(self, stream=None):
        ...
        """
        from cusimt.numba_cuda import device_array
        ...
        self._memsys = device_array((memsys_size.value,), dtype="i1", stream=stream)
