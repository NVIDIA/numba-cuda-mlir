...
from cusimt.numba_cuda.cgutils import create_constant_array
from cusimt.numba_cuda.core.imputils import (
    impl_ret_untracked,
    lower_cast,
    Registry,
)
from cusimt.numba_cuda.np import npdatetime_helpers, numpy_support, npyfuncs
from cusimt.numba_cuda.extending import overload_method
from cusimt.numba_cuda.core.config import IS_32BITS
from cusimt.numba_cuda.core.errors import LoweringError
...
lower(npdatetime_helpers.datetime_minimum, types.NPTimedelta, types.NPTimedelta)(
    datetime_minimum_impl
)
lower(npdatetime_helpers.datetime_maximum, types.NPDatetime, types.NPDatetime)(
    datetime_maximum_impl
)
lower(npdatetime_helpers.datetime_maximum, types.NPTimedelta, types.NPTimedelta)(
    datetime_maximum_impl
)
