...
from cusimt.numba_cuda.cgutils import unpack_tuple
from cusimt.numba_cuda.extending import intrinsic
from cusimt.numba_cuda import typing
from cusimt.numba_cuda.core.imputils import impl_ret_new_ref
from cusimt.numba_cuda.core.errors import RequireLiteralValue, TypingError
...
def empty_inferred(typingctx, shape):
    ...
    of undefined dtype.
    """
    from cusimt.numba_cuda.np.arrayobj import _empty_nd_impl
