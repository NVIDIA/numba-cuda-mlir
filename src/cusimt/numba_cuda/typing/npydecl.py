...
from cusimt.numba_cuda.typing.templates import AbstractTemplate, Registry, signature
...
def _sequence_of_arrays(context, func_name, arrays, dim_chooser=_homogeneous_dims):
    ...
    if dtype is None:
        raise TypingError("%s(): input arrays must have compatible dtypes" % func_name)
