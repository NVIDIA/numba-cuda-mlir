...
from cusimt.type_defs.cuda_types import (
    CUTensorMapType,
    CUTensorMapStorageType,
)

from cusimt.numba_cuda import cudadecl
...
class PrintFunctionTemplate(AbstractTemplate):
    from cusimt.cuda.print import print as print_intrinsic
...
class InlinePTXFunctionTemplate(AbstractTemplate):
    from cusimt.cuda import inline_ptx
...
class NumbaSyncthreadsTemplate(SyncthreadsTemplate):
    from cusimt.numba_cuda import syncthreads
...
class ThisGridTemplate(ConcreteTemplate):
    ...
    from cusimt.numba_cuda.types.ext_types import grid_group
...
class ConstArrayLikeTemplate(AbstractTemplate):
    ...
    key = cusimt.cuda.const.array_like
...
class LocalArrayTemplate(GenericArrayTemplate):
    ...
    key = cusimt.cuda.local.array


@registry.register_attr
class CUDALocalModule(AttributeTemplate):
    import cusimt.cuda.local as local
...
class CudaSharedModuleTemplate(AttributeTemplate):
    ...
    key = types.Module(cusimt.cuda.shared)
...
class CudaConstModuleTemplate(AttributeTemplate):
    ...
    key = types.Module(cusimt.cuda.const)
...
class CudaLocalModuleTemplate(AttributeTemplate):
    ...
    key = types.Module(cusimt.cuda.local)
...
class Cuda_stub_resolver(cudadecl.CudaModuleTemplate, AttributeTemplate):
    ...
    def resolve_local(self, mod):
        ...
        return types.Module(cusimt.cuda.local)
    ...
    def resolve_shared(self, mod):
        ...
        return types.Module(cusimt.cuda.shared)
    ...
    def resolve_intrin(self, mod):
        import cusimt.cuda.intrin as intrin
    ...
    def resolve_vector(self, mod):
        from cusimt.cuda import vector
    ...
    def generic_resolve(self, mod, attr):
        ...
        from cusimt.cuda.vector_types import (
...
class RealNumbaCudaModuleTemplate(Cuda_stub_resolver):
    import cusimt.numba_cuda as numba_cuda_module
...
try:
    ...
    def typeof_cutensormap(val, c):
        ...
        Returns the cuSIMT CUTensorMap type so these objects can be passed
