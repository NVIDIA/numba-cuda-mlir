...
from numba_cuda_mlir.numba_cuda.core import consts
import operator
from functools import reduce

from .controlflow import CFGraph
from numba_cuda_mlir.numba_cuda.misc import special
...
def rewrite_semantic_constants(func_ir, called_args):
    ...
    from numba_cuda_mlir.numba_cuda.core.ir_utils import get_definition, guard
