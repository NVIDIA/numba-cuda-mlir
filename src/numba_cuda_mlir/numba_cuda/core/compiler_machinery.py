...
from numba_cuda_mlir.numba_cuda.core import transforms
from numba_cuda_mlir.numba_cuda.core.tracing import event
from numba_cuda_mlir.numba_cuda.core.postproc import PostProcessor
...
import numba_cuda_mlir.numba_cuda.core.compiler_machinery as nccm
...
class PassManager:
    ...
    def run(self, state):
        ...
        """
        from numba_cuda_mlir.numba_cuda.core.compiler import _EarlyPipelineCompletion
