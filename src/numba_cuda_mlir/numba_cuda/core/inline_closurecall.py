...
from numba_cuda_mlir.numba_cuda.core.analysis import (
...
from numba_cuda_mlir.numba_cuda.np.unsafe.ndarray import (
    empty_inferred as unsafe_empty_inferred,
)
import numpy as np
import operator
...
class InlineWorker:
    ...
    def __init__(
        ...
        from numba_cuda_mlir.numba_cuda.compiler import DefaultPassBuilder
    ...
    def update_type_and_call_maps(self, callee_ir, arg_typs):
        ...
        from numba_cuda_mlir.numba_cuda.core import typed_passes, ir_utils
...
def length_of_iterator(typingctx, val):
    ...
    if isinstance(val, types.RangeIteratorType):
        ...
        def codegen(context, builder, sig, args):
            (value,) = args
            from numba_cuda_mlir.numba_cuda.cpython.rangeobj import range_impl_map
        ...
        def codegen(context, builder, sig, args):
            ...
            from numba_cuda_mlir.numba_cuda.np.arrayobj import make_array
