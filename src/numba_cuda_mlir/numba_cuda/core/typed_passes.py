...
from numba_cuda_mlir.numba_cuda.core import typeinfer
...
from numba_cuda_mlir.numba_cuda.core.annotations import type_annotations
...
from numba_cuda_mlir.numba_cuda.core import postproc, rewrites, funcdesc, config
...
class NoPythonBackend(LoweringPass):
    ...
    def run_pass(self, state):
        ...
        from numba_cuda_mlir.numba_cuda.compiler import cuda_compile_result
