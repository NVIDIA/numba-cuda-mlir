...
from numba_cuda_mlir.numba_cuda.typeconv.rules import default_type_manager
from numba_cuda_mlir.numba_cuda.typing.templates import fold_arguments
from numba_cuda_mlir.numba_cuda.typing.typeof import Purpose, typeof

from numba_cuda_mlir.numba_cuda import typing, types
from numba_cuda_mlir.numba_cuda.types import ext_types
from numba_cuda_mlir.numba_cuda.api import get_current_device
from numba_cuda_mlir.numba_cuda.args import wrap_arg
from numba_cuda_mlir.numba_cuda.core.bytecode import get_code_object
...
from numba_cuda_mlir.numba_cuda.errors import (
...
class _DispatcherBase:  # (_dispatcher.Dispatcher):
    ...
    def inspect_types(
        ...
        if not pretty:
            ...
            from numba_cuda_mlir.numba_cuda.core.annotations.pretty_annotate import (
                Annotate,
            )
...
class Dispatcher(serialize.ReduceMixin, _MemoMixin, _DispatcherBase):
    ...
    def __init__(self, py_func, locals=None, targetoptions=None):
        ...
        # Python here to break dependency on the Dispatcher C code for numba-cuda-mlir.
...
class CUDADispatcher(serialize.ReduceMixin, _MemoMixin, _DispatcherBase):
    ...
    def call(self, args, griddim, blockdim, stream, sharedmem):
        ...
        """
        raise RuntimeError("numba-cuda-mlir should not launch Numba-CUDA kernels")
