...
if config.ENABLE_CUDASIM:
    import sys
    from numba_cuda_mlir.numba_cuda.simulator import cudadrv
    from . import dispatcher

    sys.modules["numba.cuda.api"] = api
    ...
    from numba_cuda_mlir.numba_cuda.simulator import memory_management
