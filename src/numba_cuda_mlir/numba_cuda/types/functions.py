...
from numba_cuda_mlir.numba_cuda import utils, types, config
...
class BaseFunction(Callable):
    ...
    def get_call_type(self, context, args, kws):
        ...
        order = utils.order_by_target_specificity(self.templates, fnkey=self.key[0])
...
class ExternalFunctionPointer(BaseFunction):
    ...
    *get_pointer* is a Python function taking an object
    ...
    def __init__(self, sig, get_pointer, cconv=None):
        ...
        from numba_cuda_mlir.numba_cuda.types import ffi_forced_object
