...
from numba_cuda_mlir.numba_cuda.core.config import (
...
def unified_function_type(numba_types, require_precise=True):
    ...
    """
    from numba_cuda_mlir.numba_cuda.core.errors import NumbaExperimentalFeatureWarning
...
def dump_llvm(fndesc, module):
    ...
    if config.HIGHLIGHT_DUMPS:
        try:
            ...
            from numba_cuda_mlir.numba_cuda.misc.dump_style import by_colorscheme
