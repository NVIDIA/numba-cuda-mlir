...
Benchmarks to compare JIT compile-time and kernel performance between Numba CUDA and cuSIMT implementations. Uses NVIDIA Nsight Compute (NCU) to profile kernel execution times.
...
2. **With profiling scripts**: `CUSIMT_SKIP_REDIRECTOR=1 pytest tests/benchmarks/vector_add/ --benchmark -s`
...
```
+------------------------------+---------------------------+-----------------------+-------------------+--------------------------+----------------------+------------------+
| Benchmark                    |   Numba-CUDA Compile (ms) |   cuSIMT Compile (ms) | Compile Speedup   |   Numba-CUDA Kernel (ms) |   cuSIMT Kernel (ms) | Kernel Speedup   |
+==============================+===========================+=======================+===================+==========================+======================+==================+
