...
def run_benchmark_main(compile_mode="cold"):
    ...
    numba_compile_time = time_compile(numba_cuda_simple_attention.compile, sig)
    numba_cuda_mlir_compile_time = time_compile(numba_cuda_mlir_simple_attention.compile, sig)
