...
def run_benchmark_main(compile_mode="cold"):
    ...
    numba_compile_time = time_compile(black_scholes_numba_cuda.compile, sig)
    numba_cuda_mlir_compile_time = time_compile(black_scholes_numba_cuda_mlir.compile, sig)
