...
if __name__ == "__main__":
    val_file = os.path.join(DATA_CACHE_DIR, "tiny_shakespeare_val.bin")
    train_file = os.path.join(DATA_CACHE_DIR, "tiny_shakespeare_train.bin")
    if os.path.exists(val_file) and os.path.exists(train_file):
        print(f"{val_file} and {train_file} already exist, skipping...")
    else:
        download()
        tokenize()
