...
def test_rtsys_allocate_initialize():
    ...
    assert rtsys._memsys_module is None
    ...
    assert rtsys._memsys_module is not None
...
def test_rtsys_stats_query():
    ...
    from cusimt.memory_management import rtsys, _nrt_mstats
...
def test_rtsys_idempotent():
    ...
    module1 = rtsys._memsys_module

    # Call again - should be no-op
    rtsys.ensure_initialized()

    assert rtsys._memsys is memsys1
    assert rtsys._memsys_module is module1
