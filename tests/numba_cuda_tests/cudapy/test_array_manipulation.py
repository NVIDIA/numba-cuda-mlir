...
"""
CUDA array manipulation tests exercised inside kernels.

These tests validate element-wise operations, indexing, dtype transitions and
grid-stride traversal from within CUDA kernels. Ported from the Numba-CUDA
test-coverage effort (NVIDIA/numba-cuda#515) and adapted to the
Numba-CUDA-MLIR programming model.
"""
...
class TestArrayManipulation(NumbaCUDATestCase):
