...
# FIXME (cuSIMT): We need to import these from cuSIMT when they are available
...
class Bfloat16Test(NumbaCUDATestCase):
    ...
    @pytest.mark.xfail(True, reason="NVVM error (LTO)")
