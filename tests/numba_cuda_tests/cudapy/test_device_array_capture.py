...
from cusimt.numba_cuda.testing import ForeignArray
...
ARRAY_FACTORIES = (make_numba_array, make_foreign_array)


class TestDeviceArrayCapture(NumbaCUDATestCase):
    """Test capturing device arrays from global scope."""

    def test_basic_capture(self):
        """Test basic global capture with different array types."""
        for make_array in ARRAY_FACTORIES:
    ...
    def test_dtypes(self):
        ...
        for make_array in ARRAY_FACTORIES:
            for dtype, values in dtypes:
                ...
                np.testing.assert_array_equal(output.copy_to_host(), host_data)
