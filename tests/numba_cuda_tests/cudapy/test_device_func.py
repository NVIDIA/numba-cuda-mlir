...
class TestDeviceFunc(NumbaCUDATestCase):
    def test_use_add2f(self):
        ...
        compiled = cusimt.jit("void(float32[:])")(use_add2f)
    ...
    def test_indirect_add2f(self):
        ...
        compiled = cusimt.jit("void(float32[:])")(indirect_add2f)
    ...
    def test_device_casting(self):
        ...
        @cusimt.jit("int32(int32, int32, int32, int32)", device=True)
        def rgba(r, g, b, a):
...
class TestDeclareDevice(NumbaCUDATestCase):
