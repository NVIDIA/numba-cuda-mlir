...
from numba_cuda_mlir.numba_cuda.types import void, int32, float32, float64
from numba_cuda_mlir.cuda import guvectorize
import numba_cuda_mlir
from numba_cuda_mlir import cuda
from numba_cuda_mlir.testing import NumbaCUDATestCase
from numba_cuda_mlir.numba_cuda.core.errors import NumbaPerformanceWarning, TypingError
...
class TestCUDAGufunc(NumbaCUDATestCase):
    ...
    @pytest.mark.xfail(True, reason="Expected warning not raised")
    ...
    def test_inefficient_launch_configuration(self):
        ...
        with pytest.warns(NumbaPerformanceWarning, match="Grid size .+ low occupancy"):
...
class TestMultipleOutputs(NumbaCUDATestCase):
    @pytest.mark.xfail(True, reason="guvectorize not supported")
