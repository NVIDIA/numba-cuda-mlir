...
class TestInspect(NumbaCUDATestCase):
    @property
    def cc(self):
    ...
    def test_polytyped(self):
        ...
        self.assertFileCheckLLVM(foo, int_sig, check_prefixes=["LLVM", "LLVM_INT"])
        self.assertFileCheckAsm(foo, int_sig, check_prefixes=["ASM"])
        self.assertFileCheckLLVM(foo, float_sig, check_prefixes=["LLVM", "LLVM_FLOAT"])
