...
from numba_cuda_mlir.numba_cuda.compiler import CompilerBase
...
from numba_cuda_mlir.numba_cuda.core import ir, bytecode
from numba_cuda_mlir.numba_cuda.core import compiler
...
class TestIrUtils(NumbaCUDATestCase):
    """
