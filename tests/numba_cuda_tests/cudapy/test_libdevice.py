...
from cusimt.cuda import libdevice
from cusimt.cuda.libdevicefuncs import functions, create_signature
...
class TestLibdevice(NumbaCUDATestCase):
    """
...
class TestLibdeviceCompilation(NumbaCUDATestCase):
    """
