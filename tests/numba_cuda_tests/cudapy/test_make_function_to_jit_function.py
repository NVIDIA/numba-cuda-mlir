...
class TestMakeFunctionToJITFunction(NumbaCUDATestCase):
    """
    ...
    def test_escape_with_kwargs_override_kwargs(self):
        ...
        cfunc = wrap_with_kernel_noarg_tuple_return(impl_factory(specialised_consumer))
