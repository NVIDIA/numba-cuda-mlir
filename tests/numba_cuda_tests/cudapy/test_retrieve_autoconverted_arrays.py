...
class TestRetrieveAutoconvertedArrays(NumbaCUDATestCase):
    def setUp(self):
        super().setUp()
        self.set_array_to_three = cusimt.jit(set_array_to_three)
        self.set_array_to_three_nocopy = nocopy(cusimt.jit(set_array_to_three))
        self.set_record_to_three = cusimt.jit(set_record_to_three)
        self.set_record_to_three_nocopy = nocopy(cusimt.jit(set_record_to_three))
