...
from numba_cuda_mlir.cuda.kernels.transpose import transpose
...
class TestTranspose(NumbaCUDATestCase):
    @pytest.mark.xfail(True, reason="Kernel implementation issue")
