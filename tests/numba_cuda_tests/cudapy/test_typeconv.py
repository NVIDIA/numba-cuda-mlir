...
from numba_cuda_mlir.numba_cuda.typeconv.typeconv import TypeManager, TypeCastingRules
from numba_cuda_mlir.numba_cuda.typeconv import rules
from numba_cuda_mlir.numba_cuda.typeconv import castgraph, Conversion
from numba_cuda_mlir.testing import NumbaCUDATestCase


class CompatibilityTestMixin(NumbaCUDATestCase):
...
class TestTypeConv(CompatibilityTestMixin):
