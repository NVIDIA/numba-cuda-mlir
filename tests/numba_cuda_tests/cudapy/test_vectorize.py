...
from numba_cuda_mlir.cuda import vectorize as cuda_vectorize
from numba_cuda_mlir import cuda

# from numba import vectorize as numba_vectorize
from numba_cuda_mlir.numba_cuda.types import int32, float32, float64
...
class TestCUDAVectorize(NumbaCUDATestCase):
