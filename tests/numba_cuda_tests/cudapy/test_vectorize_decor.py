...
from numba_cuda_mlir.numba_cuda.types import int32, uint32, float32, float64
...
class BaseVectorizeNopythonArg(NumbaCUDATestCase):
    """
...
class BaseVectorizeUnrecognizedArg(NumbaCUDATestCase):
    """
...
class TestVectorizeDecor(NumbaCUDATestCase, BaseVectorizeDecor):
    """
...
@pytest.mark.xfail(True, reason="Vectorize not supported")
class TestGPUVectorizeBroadcast(NumbaCUDATestCase):
