...
from cusimt.numba_cuda.datamodel.models import PrimitiveModel
...
from cusimt.models import register_model
...
def _register_uint64_pointer_setitem():
    from cusimt.extending import typing_registry, lowering_registry
    from cusimt import lowering_utilities
    from cusimt.mlir_lowering import MLIRLower
    from cusimt.mlir.dialect_exts import memref
