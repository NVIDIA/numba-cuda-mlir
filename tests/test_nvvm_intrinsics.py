...
from cuda.simt import compiler, testing, typing, tools
import ctypes
import pytest
...
def test_nvvm_intrinsics():
    ...
    # CHECK-SAME:      %{{.*}}: i64) attributes {cusimt.arg_attrs = [{}, {}], cusimt.orig_arg_types = [memref<?xf32, strided<[?], offset: ?>>, memref<?xf32, strided<[?], offset: ?>>], gpu.kernel, llvm.emit_c_interface, nvvm.kernel} {
